import win from './win'
import type { TransformFunction, TypesetOptions } from './types'
...
class HTMLProcessor {
  ...
  private options: TypesetOptions

  constructor(transformFunctions: TransformFunction[], options: TypesetOptions) {
